...
<div class="container-fluid banner">
		...
		<div class="container bg-light" style="padding-top:6%;">
			...
			<br>
			<p style="padding-left:5%; padding-right:5%; padding-bottom:3%; color:black">Notre système peut être utilisé dans le domaine de l'IOT. En effet, on pourrait contrôler des objets connectés depuis notre application. Par exemple, on pourrait envoyer une requête à une lampe connectée pour que celle-ci change de couleur.
			</p>
