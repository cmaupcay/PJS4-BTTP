...
<html>
  ...
  <body>
    ...
    <header class="header">
        <nav class="navbar navbar-expand-lg fixed-top py-3 fill">
			<div><a href="index.php?controle=visiteurs&action=accueil" class="nav-link text-uppercase font-weight-bold">Logo-pour-accueil</a></div>
            <div class="container" >
  ...
  <div class="o-bg">
	  <div class = "presentation">
		...
		<a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a>
		<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#slide1">montrer plus de scripts</button>
		<div id="slide1" class="collapse">
			<a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a><a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <br>
			<a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a><a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a>
		</div>
	  </div>
	  <div class = "presentation">
		<h2><a href="ordi.html">Gerer ordinateurs connectés : </a></h2>
		<a href="ordi"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="ordi"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="ordi"><img src="e.bmp" alt="..." class="img-thumbnail"></a>
		<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#slide2">montrer plus de scripts</button>
	  ...
	  <div class = "presentation">
		...
		<a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a> <a href="script"><img src="e.bmp" alt="..." class="img-thumbnail"></a>
		<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#slide3">montrer plus de scripts</button>
