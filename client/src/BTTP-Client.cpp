...
namespace BTTP 
{
    ...
    namespace Client 
    {
        ...
        void exporter(const Protocole::Identite& identite, const std::string dossier, const bool utiliser_contexte, const bool creer_chemin) 
        {
            ...
            Fichiers::ecrire(identite.exporter(), nom + '.' + BTTP_IDENTITE_EXT, dossier, utiliser_contexte, creer_chemin);
        ...
        {
            std::istream fichier = Fichiers::lecture(nom + '.' + BTTP_IDENTITE_EXT, dossier, utiliser_contexte); 
